...
这份文档按“指令 / 人话说明 / 调用示例 / 技术说明”整理，适合先快速看懂这个指令是干嘛的，再直接抄示例调用。
...
如果你想直接点指令、立刻看图形效果，优先打开上面的 demo 页；文档更适合查名称、抄调用代码和看效果图。
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>拿三个点就能画出一个角。</td>
      <td><pre><code>board.create(&#x27;angle&#x27;, [A, B, C], { radius: 1.2 });</code></pre></td>
    ...
    <tr>
      <td><code>arc</code></td>
      <td>从一个圆里截出一段弧。</td>
      <td><pre><code>board.create(&#x27;arc&#x27;, [A, B, C]);</code></pre></td>
    ...
    <tr>
      ...
      <td><pre><code>board.create(&#x27;arrow&#x27;, [A, B]);</code></pre></td>
    ...
    <tr>
      ...
      <td><pre><code>board.create(&#x27;arrowparallel&#x27;, [A, B, C]);</code></pre></td>
    ...
    <tr>
      ...
      <td><pre><code>// éå¸¸ç± view3d åé¨ç®¡ç
const view = engine3d.getView3D();</code></pre></td>
    ...
    <tr>
      ...
      <td><pre><code>board.create(&#x27;axis&#x27;, [[0, 0], [1, 0]]);</code></pre></td>
    ...
    <tr>
      ...
      <td>3D 里的单根坐标轴。</td>
      <td><pre><code>view.create(&#x27;axis3d&#x27;, [[0, 0, 0], [4, 0, 0]]);</code></pre></td>
    ...
    <tr>
      ...
      <td>把一个角从中间平分开。</td>
      <td><pre><code>board.create(&#x27;bisector&#x27;, [A, B, C]);</code></pre></td>
    ...
    <tr>
      ...
      <td><pre><code>board.create(&#x27;bisectorlines&#x27;, [lAB, lCD]);</code></pre></td>
    ...
    <tr>
      ...
      <td>统计课里常见的箱线图。</td>
      <td><pre><code>board.create(&#x27;boxplot&#x27;, [[1, 3, 4, 6, 8], 1, 0.8], { dir: &#x27;vertical&#x27; });</code></pre></td>
    ...
    <tr>
      ...
      <td>往画板里塞一个可以点的按钮。</td>
      <td><pre><code>board.create(&#x27;button&#x27;, [-7, 7, &#x27;ç¹æ&#x27;, () =&gt; alert(&#x27;clicked&#x27;)]);</code></pre></td>
    ...
    <tr>
      ...
      <td>把几个点顺滑地连成一条曲线。</td>
      <td><pre><code>board.create(&#x27;cardinalspline&#x27;, [[A, B, C, D], 0.6, &#x27;uniform&#x27;]);</code></pre></td>
    ...
    <tr>
      ...
      <td><pre><code>board.create(&#x27;chart&#x27;, [[1, 2, 3, 4], [2, 1, 3, 2]], { chartStyle: &#x27;line,point&#x27; });</code></pre></td>
    ...
    <tr>
      ...
      <td>往画板里塞一个勾选框。</td>
      <td><pre><code>board.create(&#x27;checkbox&#x27;, [-7, 6, &#x27;æ¾ç¤ºè¾å©çº¿&#x27;]);</code></pre></td>
      <td>创建 HTML 复选框控件。</td>
    ...
    <tr>
      ...
      <td>圆心 + 半径/点/线/圆</td>
      <td><pre><code>board.create(&#x27;circle&#x27;, [A, B]);</code></pre></td>
    ...
    <tr>
      ...
      <td>在 3D 空间里画一个圆。</td>
      <td><pre><code>view.create(&#x27;circle3d&#x27;, [Q5, [1, 1, 1], 1.4], { strokeColor: &#x27;#ef4444&#x27;, strokeWidth: 3 });</code></pre></td>
      <td>创建三维圆。</td>
    ...
    <tr>
      ...
      <td>直接找三角形的外心。</td>
      <td><pre><code>board.create(&#x27;circumcenter&#x27;, [A, B, C]);</code></pre></td>
    ...
    <tr>
      ...
      <td>让一个圆刚好穿过三个点。</td>
      <td><pre><code>board.create(&#x27;circumcircle&#x27;, [A, B, C]);</code></pre></td>
      <td>创建经过三点的外接圆。</td>
    ...
    <tr>
      ...
      <td><pre><code>board.create(&#x27;circumcirclearc&#x27;, [A, B, C]);</code></pre></td>
      <td>创建三点外接圆上的圆弧。</td>
    ...
    <tr>
      ...
      <td><pre><code>board.create(&#x27;circumcirclemidpoint&#x27;, [A, B, C]);</code></pre></td>
    ...
    <tr>
      ...
      <td><pre><code>board.create(&#x27;circumcirclesector&#x27;, [A, B, C]);</code></pre></td>
      <td>创建三点外接圆上的扇形区域。</td>
    ...
    <tr>
      ...
      <td>在线段边上加一排小梳齿标记。</td>
      <td><pre><code>board.create(&#x27;comb&#x27;, [A, B]);</code></pre></td>
    ...
    <tr>
      ...
      <td><pre><code>board.create(&#x27;conic&#x27;, [A, B, C, D, E]);</code></pre></td>
    ...
    <tr>
      ...
      <td>画一条普通 2D 曲线。</td>
      <td><pre><code>board.create(&#x27;curve&#x27;, [t =&gt; Math.cos(t), t =&gt; Math.sin(t), 0, 2 * Math.PI]);</code></pre></td>
    ...
    <tr>
      ...
      <td>画一条空间里的 3D 曲线。</td>
      <td><pre><code>view.create(&#x27;curve3d&#x27;, [u =&gt; Math.cos(u), u =&gt; Math.sin(u), u =&gt; u / 3, [0, 6 * Math.PI]]);</code></pre></td>
    ...
    <tr>
      ...
      <td>两个闭合曲线/圆/多边形</td>
      <td><pre><code>board.create(&#x27;curvedifference&#x27;, [poly1, poly2], { fillColor: &#x27;#f97316&#x27;, fillOpacity: 0.2 });</code></pre></td>
    ...
    <tr>
      ...
      <td>两个闭合曲线/圆/多边形</td>
      <td><pre><code>board.create(&#x27;curveintersection&#x27;, [poly1, poly2], { fillColor: &#x27;#22c55e&#x27;, fillOpacity: 0.2 });</code></pre></td>
    ...
    <tr>
      ...
      <td>两个闭合曲线/圆/多边形</td>
      <td><pre><code>board.create(&#x27;curveunion&#x27;, [poly1, poly2], { fillColor: &#x27;#3b82f6&#x27;, fillOpacity: 0.2 });</code></pre></td>
    ...
    <tr>
      ...
      <td><pre><code>board.create(&#x27;derivative&#x27;, [fg]);</code></pre></td>
      <td>创建某条曲线的导函数图像。</td>
    ...
    <tr>
      ...
      <td>画椭圆。</td>
      <td><pre><code>board.create(&#x27;ellipse&#x27;, [A, B, C]);</code></pre></td>
      <td>创建椭圆。</td>
    ...
    <tr>
      ...
      <td>画 3D 物体的一个面片。</td>
      <td><pre><code>const solid = view.create(&#x27;polyhedron3d&#x27;, [[[0,0,0],[2,0,0],[0,2,0],[0,0,2]], [[0,1,2],[0,1,3],[0,2,3],[1,2,3]]], { fillOpacity: 0.08, edges: { strokeColor: &#x27;#94a3b8&#x27; } }); solid.faces[0].setAttribute({ fillColor: &#x27;#f97316&#x27;, fillOpacity: 0.5, strokeWidth: 2 });</code></pre></td>
    ...
    <tr>
      ...
      <td><pre><code>board.create(&#x27;fo&#x27;, [&#x27;&lt;div style=\&quot;padding:6px\&quot;&gt;FO&lt;/div&gt;&#x27;, [-7, -1], [2.2, 1.2]]);</code></pre></td>
    ...
    <tr>
      ...
      <td>HTML 内容 + 位置 + 尺寸</td>
      <td><pre><code>board.create(&#x27;foreignobject&#x27;, [&#x27;&lt;div style=\&quot;padding:6px\&quot;&gt;Hello&lt;/div&gt;&#x27;, [-7, -1], [2.2, 1.2]]);</code></pre></td>
    ...
    <tr>
      ...
      <td><pre><code>board.create(&#x27;functiongraph&#x27;, [x =&gt; Math.sin(x)], { strokeColor: &#x27;#2563eb&#x27; });</code></pre></td>
      <td>创建二维函数图像。</td>
    ...
    <tr>
      ...
      <td><pre><code>view.create(&#x27;functiongraph3d&#x27;, [(x, y) =&gt; Math.sin(x) * Math.cos(y), [-3, 3], [-3, 3]]);</code></pre></td>
    ...
    <tr>
      ...
      <td><pre><code>board.create(&#x27;glider&#x27;, [0.5, 0.5, fg]);</code></pre></td>
    ...
    <tr>
      ...
      <td>打开网格背景。</td>
      <td><pre><code>board.create(&#x27;grid&#x27;, []);</code></pre></td>
      <td>创建网格。</td>
    ...
    <tr>
      ...
      <td>画板 + 元素数组 + 属性</td>
      <td><pre><code>const group = board.create(&#x27;group&#x27;, [[A, B, C], {}]);</code></pre></td>
    ...
    <tr>
      ...
      <td><pre><code>board.create(&#x27;hash&#x27;, [lAB, 3]);</code></pre></td>
    ...
    <tr>
      ...
      <td>给对象加斜线纹或刻纹标记。</td>
      <td><pre><code>board.create(&#x27;hatch&#x27;, [lAB, 4]);</code></pre></td>
    ...
    <tr>
      ...
      <td>画板里的 HTML 版滑块。</td>
      <td><pre><code>board.create(&#x27;htmlslider&#x27;, [[-7, 5], [0, 3, 10]]);</code></pre></td>
      <td>创建 HTML 版滑块控件。</td>
    ...
    <tr>
      ...
      <td>画双曲线。</td>
      <td><pre><code>board.create(&#x27;hyperbola&#x27;, [A, B, C]);</code></pre></td>
      <td>创建双曲线。</td>
    ...
    <tr>
      ...
      <td>图片 URL + 位置 + 尺寸</td>
      <td><pre><code>board.create(&#x27;image&#x27;, [&#x27;https://dummyimage.com/120x80/e5e7eb/111827&amp;text=img&#x27;, [-7, -4], [3, 2]]);</code></pre></td>
      <td>在画板中插入图片。</td>
    ...
    <tr>
      ...
      <td><pre><code>board.create(&#x27;implicitcurve&#x27;, [&#x27;x^2 + y^2 - 9&#x27;]);</code></pre></td>
    ...
    <tr>
      ...
      <td>直接找三角形的内心。</td>
      <td><pre><code>board.create(&#x27;incenter&#x27;, [A, B, C]);</code></pre></td>
      <td>创建三角形内心。</td>
    ...
    <tr>
      ...
      <td>画三角形的内切圆。</td>
      <td><pre><code>board.create(&#x27;incircle&#x27;, [A, B, C]);</code></pre></td>
      <td>创建三角形内切圆。</td>
    ...
    <tr>
      ...
      <td>直线或函数图像</td>
      <td><pre><code>board.create(&#x27;inequality&#x27;, [fg], { inverse: false, fillOpacity: 0.15 });</code></pre></td>
    ...
    <tr>
      ...
      <td>往画板里塞一个输入框。</td>
      <td><pre><code>board.create(&#x27;input&#x27;, [-7, 4, &#x27;sin(x)&#x27;, &#x27;f(x)=&#x27;]);</code></pre></td>
      <td>创建 HTML 文本输入框。</td>
    ...
    <tr>
      ...
      <td>区间 + 曲线</td>
      <td><pre><code>board.create(&#x27;integral&#x27;, [[-2, 2], fg]);</code></pre></td>
      <td>创建积分区域或积分相关图形。</td>
    ...
    <tr>
      ...
      <td>两个对象 + 交点索引</td>
      <td><pre><code>board.create(&#x27;intersection&#x27;, [c1, c2, 0]);</code></pre></td>
      <td>创建两个对象的交点。</td>
    ...
    <tr>
      ...
      <td>球与球/平面</td>
      <td><pre><code>view.create(&#x27;intersectioncircle3d&#x27;, [sphereA, planeA]);</code></pre></td>
    ...
    <tr>
      ...
      <td>两个平面</td>
      <td><pre><code>view.create(&#x27;intersectionline3d&#x27;, [planeA, planeB]);</code></pre></td>
      <td>创建两个平面相交得到的直线。</td>
    ...
    <tr>
      ...
      <td>给图表配一个图例说明。</td>
      <td><pre><code>board.create(&#x27;legend&#x27;, [5.5, 7.5]);</code></pre></td>
      <td>创建图表图例。</td>
    ...
    <tr>
      ...
      <td>画直线。</td>
      <td><pre><code>board.create(&#x27;line&#x27;, [A, B]);</code></pre></td>
      <td>创建二维直线。</td>
    ...
    <tr>
      ...
      <td>画空间直线。</td>
      <td><pre><code>view.create(&#x27;line3d&#x27;, [[0, 0, 0], [2, 1, 1]]);</code></pre></td>
      <td>创建三维直线、射线或线段。</td>
    ...
    <tr>
      ...
      <td>取圆上比较大的那段弧。</td>
      <td><pre><code>board.create(&#x27;majorarc&#x27;, [A, B, C]);</code></pre></td>
    ...
    <tr>
      ...
      <td>取圆上比较大的那块扇形。</td>
      <td><pre><code>board.create(&#x27;majorsector&#x27;, [A, B, C]);</code></pre></td>
    ...
    <tr>
      ...
      <td><pre><code>board.create(&#x27;measurement&#x27;, [A, B, [&#x27;Dist&#x27;, &#x27;A&#x27;, &#x27;B&#x27;]]);</code></pre></td>
    ...
    <tr>
      ...
      <td>画一个 3D 网格面。</td>
      <td><pre><code>view.create(&#x27;mesh3d&#x27;, [[0, 0, 0], [1, 0, 0], [0, 1, 0], [-2, 2], [-2, 2]]);</code></pre></td>
      <td>创建三维网格面。</td>
    ...
    <tr>
      ...
      <td><pre><code>board.create(&#x27;metapostspline&#x27;, [[A, B, C, D], { tension: 1 }]);</code></pre></td>
    ...
    <tr>
      ...
      <td>找中点。</td>
      <td><pre><code>board.create(&#x27;midpoint&#x27;, [A, B]);</code></pre></td>
      <td>创建中点。</td>
    ...
    <tr>
      ...
      <td>取圆上比较短的那段弧。</td>
      <td><pre><code>board.create(&#x27;minorarc&#x27;, [A, B, C]);</code></pre></td>
    ...
    <tr>
      ...
      <td>取圆上比较小的那块扇形。</td>
      <td><pre><code>board.create(&#x27;minorsector&#x27;, [A, B, C]);</code></pre></td>
    ...
    <tr>
      ...
      <td>对象 + 镜像中心点</td>
      <td><pre><code>board.create(&#x27;mirrorelement&#x27;, [segAB, O]);</code></pre></td>
      <td>按点对一个图形做中心对称。</td>
    ...
    <tr>
      ...
      <td><pre><code>board.create(&#x27;mirrorpoint&#x27;, [O, A]);</code></pre></td>
    ...
    <tr>
      ...
      <td><pre><code>board.create(&#x27;msector&#x27;, [A, B, C]); // æäºçæ¬å¯è½éè¦å¾®è°</code></pre></td>
    ...
    <tr>
      ...
      <td><pre><code>board.create(&#x27;nonreflexangle&#x27;, [A, B, C]);</code></pre></td>
    ...
    <tr>
      ...
      <td>对象 + 点</td>
      <td><pre><code>board.create(&#x27;normal&#x27;, [fg, G]);</code></pre></td>
    ...
    <tr>
      ...
      <td>把一个点垂直投到一条线上。</td>
      <td><pre><code>board.create(&#x27;orthogonalprojection&#x27;, [C, lAB]);</code></pre></td>
      <td>创建点到直线的正交投影点。</td>
    ...
    <tr>
      ...
      <td>两个对象 + 已知交点</td>
      <td><pre><code>board.create(&#x27;otherintersection&#x27;, [c1, c2, I0]);</code></pre></td>
    ...
    <tr>
      ...
      <td>画抛物线。</td>
      <td><pre><code>board.create(&#x27;parabola&#x27;, [A, lCD]);</code></pre></td>
      <td>创建抛物线。</td>
    ...
    <tr>
      ...
      <td>过某个点画一条平行线。</td>
      <td><pre><code>board.create(&#x27;parallel&#x27;, [lAB, C]);</code></pre></td>
    ...
    <tr>
      ...
      <td>拿三个点补出一个平行四边形。</td>
      <td><pre><code>board.create(&#x27;parallelogram&#x27;, [A, B, C]);</code></pre></td>
      <td>用三点构造平行四边形。</td>
    ...
    <tr>
      ...
      <td><pre><code>board.create(&#x27;parallelpoint&#x27;, [A, B, C]);</code></pre></td>
    ...
    <tr>
      ...
      <td><pre><code>view.create(&#x27;parametricsurface3d&#x27;, [(u, v) =&gt; (3 + Math.cos(v)) * Math.cos(u), (u, v) =&gt; (3 + Math.cos(v)) * Math.sin(u), (u, v) =&gt; Math.sin(v), [0, 2 * Math.PI], [0, 2 * Math.PI]], { stepsU: 24, stepsV: 16, fillOpacity: 0.45 });</code></pre></td>
      <td>创建三维参数曲面。</td>
    ...
    <tr>
      ...
      <td>直线 + 点</td>
      <td><pre><code>board.create(&#x27;perpendicular&#x27;, [lAB, C]);</code></pre></td>
    ...
    <tr>
      ...
      <td>找垂足。</td>
      <td><pre><code>board.create(&#x27;perpendicularpoint&#x27;, [C, lAB]);</code></pre></td>
      <td>创建点在直线上的垂足。</td>
    ...
    <tr>
      ...
      <td>直线 + 点</td>
      <td><pre><code>board.create(&#x27;perpendicularsegment&#x27;, [lAB, C]);</code></pre></td>
      <td>创建从点到直线的垂线段。</td>
    ...
    <tr>
      ...
      <td>画一个 3D 平面。</td>
      <td><pre><code>view.create(&#x27;plane3d&#x27;, [[0, 0, 0], [1, 0, 0], [0, 1, 0], [-2, 2], [-2, 2]]);</code></pre></td>
      <td>创建三维平面。</td>
    ...
    <tr>
      ...
      <td><pre><code>board.create(&#x27;plot&#x27;, [x =&gt; Math.cos(x)], { strokeColor: &#x27;#ef4444&#x27; });</code></pre></td>
    ...
    <tr>
      ...
      <td>画点。</td>
      <td><pre><code>board.create(&#x27;point&#x27;, [1, 2]);</code></pre></td>
      <td>创建二维点。</td>
    ...
    <tr>
      ...
      <td>在空间里放一个点。</td>
      <td><pre><code>view.create(&#x27;point3d&#x27;, [1, 2, 3]);</code></pre></td>
      <td>创建三维点。</td>
    ...
    <tr>
      ...
      <td>圆锥曲线/圆 + 点</td>
      <td><pre><code>board.create(&#x27;polar&#x27;, [c1, C]);</code></pre></td>
    ...
    <tr>
      ...
      <td>圆锥曲线/圆 + 点</td>
      <td><pre><code>board.create(&#x27;polarline&#x27;, [c1, C]);</code></pre></td>
    ...
    <tr>
      ...
      <td>圆锥曲线/圆 + 线/点</td>
      <td><pre><code>board.create(&#x27;polepoint&#x27;, [c1, lAB]);</code></pre></td>
      <td>创建极线对应的极点。</td>
    ...
    <tr>
      ...
      <td>画多边形。</td>
      <td><pre><code>board.create(&#x27;polygon&#x27;, [A, B, C, D]);</code></pre></td>
      <td>创建二维多边形。</td>
    ...
    <tr>
      ...
      <td>画 3D 多边形面。</td>
      <td><pre><code>view.create(&#x27;polygon3d&#x27;, [[0, 0, 0], [2, 0, 0], [1, 2, 0]]);</code></pre></td>
      <td>创建三维多边形。</td>
    ...
    <tr>
      ...
      <td>画折线，但不自动封口。</td>
      <td><pre><code>board.create(&#x27;polygonalchain&#x27;, [A, B, C, D]);</code></pre></td>
      <td>创建折线链，不自动闭合。</td>
    ...
    <tr>
      ...
      <td>画一个完整 3D 多面体。</td>
      <td><pre><code>view.create(&#x27;polyhedron3d&#x27;, [[[0,0,0],[2,0,0],[2,2,0],[0,2,0],[0,0,2],[2,0,2],[2,2,2],[0,2,2]], [[0,1,2,3],[4,5,6,7],[0,1,5,4],[1,2,6,5],[2,3,7,6],[3,0,4,7]]], { fillOpacity: 0.2 });</code></pre></td>
      <td>创建三维多面体。</td>
    ...
    <tr>
      ...
      <td>找两个圆的根轴。</td>
      <td><pre><code>board.create(&#x27;radicalaxis&#x27;, [c1, c2]);</code></pre></td>
      <td>创建两圆的根轴。</td>
    ...
    <tr>
      ...
      <td>对象 + 直线</td>
      <td><pre><code>board.create(&#x27;reflection&#x27;, [A, lCD]);</code></pre></td>
      <td>按直线对一个对象做镜像反射。</td>
    ...
    <tr>
      ...
      <td><pre><code>board.create(&#x27;reflexangle&#x27;, [A, B, C]);</code></pre></td>
    ...
    <tr>
      ...
      <td>画正多边形。</td>
      <td><pre><code>board.create(&#x27;regularpolygon&#x27;, [A, B, 5]);</code></pre></td>
      <td>创建正多边形。</td>
    ...
    <tr>
      ...
      <td><pre><code>board.create(&#x27;riemannsum&#x27;, [x =&gt; Math.sin(x) + 2, 8, &#x27;left&#x27;, -3, 3]);</code></pre></td>
    ...
    <tr>
      ...
      <td>画扇形。</td>
      <td><pre><code>board.create(&#x27;sector&#x27;, [A, B, C]);</code></pre></td>
      <td>创建扇形区域。</td>
    ...
    <tr>
      ...
      <td>画线段。</td>
      <td><pre><code>board.create(&#x27;segment&#x27;, [A, B]);</code></pre></td>
      <td>创建线段。</td>
    ...
    <tr>
      ...
      <td>画半圆。</td>
      <td><pre><code>board.create(&#x27;semicircle&#x27;, [A, B]);</code></pre></td>
      <td>创建半圆。</td>
    ...
    <tr>
      ...
      <td>画一个可拖动的数值滑块。</td>
      <td><pre><code>board.create(&#x27;slider&#x27;, [[-7, 3], [-1, 3], [0, 2, 5]]);</code></pre></td>
      <td>创建滑块。</td>
    ...
    <tr>
      ...
      <td>画微分方程的斜率场。</td>
      <td><pre><code>board.create(&#x27;slopefield&#x27;, [(x, y) =&gt; x - y, [-4, 10, 4], [-4, 10, 4]]);</code></pre></td>
      <td>创建微分方程斜率场。</td>
    ...
    <tr>
      ...
      <td><pre><code>board.create(&#x27;slopetriangle&#x27;, [tangentFg]);</code></pre></td>
    ...
    <tr>
      ...
      <td>父对象 + 可选文本</td>
      <td><pre><code>board.create(&#x27;smartlabel&#x27;, [segAB]);</code></pre></td>
    ...
    <tr>
      ...
      <td>画球。</td>
      <td><pre><code>view.create(&#x27;sphere3d&#x27;, [Q1, 2]);</code></pre></td>
      <td>创建球体。</td>
    ...
    <tr>
      ...
      <td>用样条方式平滑连点。</td>
      <td><pre><code>board.create(&#x27;spline&#x27;, [[A, B, C, D]]);</code></pre></td>
      <td>创建样条插值曲线。</td>
    ...
    <tr>
      ...
      <td>画阶梯函数。</td>
      <td><pre><code>board.create(&#x27;stepfunction&#x27;, [[-3, -1, 1, 3], [1, 3, 2, 4]]);</code></pre></td>
      <td>创建阶梯函数图像。</td>
    ...
    <tr>
      ...
      <td>画切线。</td>
      <td><pre><code>board.create(&#x27;tangent&#x27;, [G]);</code></pre></td>
      <td>创建切线。</td>
    ...
    <tr>
      ...
      <td>从外部一点向圆或曲线作切线。</td>
      <td><pre><code>board.create(&#x27;tangentto&#x27;, [c1, D, 0]);</code></pre></td>
    ...
    <tr>
      ...
      <td>像卷尺一样量两点距离。</td>
      <td><pre><code>board.create(&#x27;tapemeasure&#x27;, [[-4, -5], [3, -5]]);</code></pre></td>
      <td>创建卷尺/测距工具。</td>
    ...
    <tr>
      ...
      <td>在画板上写字。</td>
      <td><pre><code>board.create(&#x27;text&#x27;, [-7, 7.5, &#x27;Hello VueGraphX&#x27;]);</code></pre></td>
      <td>创建文本标签。</td>
    ...
    <tr>
      ...
      <td>在 3D 场景里放文字。</td>
      <td><pre><code>view.create(&#x27;text3d&#x27;, [1, 1, 1, &#x27;P&#x27;]);</code></pre></td>
      <td>创建三维文本标签。</td>
    ...
    <tr>
      ...
      <td>直线/曲线 + 刻度数组</td>
      <td><pre><code>board.create(&#x27;ticks&#x27;, [lAB, [-2, -1, 0, 1, 2]]);</code></pre></td>
      <td>创建刻度。</td>
    ...
    <tr>
      ...
      <td>给 3D 轴或线加刻度。</td>
      <td><pre><code>view.create(&#x27;ticks3d&#x27;, [[0, 0, 0], [1, 0, 0], 4, [0, 0.25, 0]]);</code></pre></td>
      <td>创建三维刻度。</td>
    ...
    <tr>
      ...
      <td>把运动点走过的轨迹留下来。</td>
      <td><pre><code>board.create(&#x27;tracecurve&#x27;, [G, T]);</code></pre></td>
    ...
    <tr>
      ...
      <td><pre><code>const tr = board.create(&#x27;transform&#x27;, [1.5, 0.5], { type: &#x27;translate&#x27; }); board.create(&#x27;point&#x27;, [A, tr], { name: &#x27;A1&#x27; });</code></pre></td>
    ...
    <tr>
      ...
      <td>3D 版的平移旋转缩放规则。</td>
      <td><pre><code>const rot = view.create(&#x27;transform3d&#x27;, [Math.PI / 6], { type: &#x27;rotateZ&#x27; });</code></pre></td>
    ...
    <tr>
      ...
      <td>画板 + 选项</td>
      <td><pre><code>const turtle = board.create(&#x27;turtle&#x27;, []); turtle.forward(2); turtle.right(120); turtle.forward(2); turtle.right(120); turtle.forward(2);</code></pre></td>
      <td>创建海龟绘图对象。</td>
    ...
    <tr>
      ...
      <td>画二维向量场。</td>
      <td><pre><code>board.create(&#x27;vectorfield&#x27;, [[(x, y) =&gt; -y, (x, y) =&gt; x], [-4, 8, 4], [-4, 8, 4]]);</code></pre></td>
      <td>创建二维向量场。</td>
    ...
    <tr>
      ...
      <td>画三维向量场。</td>
      <td><pre><code>view.create(&#x27;vectorfield3d&#x27;, [[(x, y, z) =&gt; y, (x, y, z) =&gt; -x, (x, y, z) =&gt; z], [-2, 4, 2], [-2, 4, 2], [-2, 4, 2]]);</code></pre></td>
      <td>创建三维向量场。</td>
    ...
    <tr>
      ...
      <td><pre><code>board3d.create(&#x27;view3d&#x27;, [[-6, -3], [8, 8], [[-5, 5], [-5, 5], [-5, 5]]]);</code></pre></td>
